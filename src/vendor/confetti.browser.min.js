...
!function (t, e) {
	!function t(e, a, n, r) {
		var o = !!(e.Worker && e.Blob && e.Promise && e.OffscreenCanvas && e.OffscreenCanvasRenderingContext2D &&
				e.HTMLCanvasElement && e.HTMLCanvasElement.prototype.transferControlToOffscreen && e.URL &&
				e.URL.createObjectURL),
			i = 'function' == typeof Path2D && 'function' == typeof DOMMatrix,
			l = function () {
				if (!e.OffscreenCanvas) return !1
				try {
					var t = new OffscreenCanvas(1, 1), a = t.getContext('2d')
					a.fillRect(0, 0, 1, 1)
		...
		function s() {}
		function c(t) {
			var n = a.exports.Promise, r = void 0 !== n ? n : e.Promise
		...
		function F(t, e) {
			...
			} else {t.moveTo(Math.floor(e.x), Math.floor(e.y)),
		...
		function A(t, a) {
					...
					var l,
						...
						u = c(function (e) {
							...
							l = x.frame(function e() {
								!n || o.width === r.width && o.height === r.height ||
			...
			function b(a) {
				var n = f || T(a, 'disableForReducedMotion', Boolean), r = T(a, 'zIndex', Number)
				if (n && g) {
					return c(function (t) {
						t()
					})
				...
				l && i ? t = i.canvas : l && !t && (t = function (t) {
					...
					document.body.appendChild(t)), s && !m && d(t)
		...
		a.exports = function () {
			...
			a.exports.shapeFromPath = function (t) {
				...
				var n = new Path2D(e), r = document.createElement('canvas').getContext('2d')
				if (!a) {
			...
			a.exports.shapeFromText = function (t) {
				...
				var o = 10 * a, i = o + 'px ' + r, l = new OffscreenCanvas(o, o), s = l.getContext('2d')
				s.font = i
